 ...
 * FosUser
 *
 * @ORM\Table(name="fos_user", uniqueConstraints={@ORM\UniqueConstraint(name="fos_user_email_canonical_key", columns={"email_canonical"}), @ORM\UniqueConstraint(name="fos_user_username_canonical_key", columns={"username_canonical"})})
 * @ORM\Entity(repositoryClass="S\VentasBundle\Repository\FosUserR")
 */
class FosUser
{
    /**
     ...
     * @var integer
     *
     * @ORM\Column(name="user_father", type="integer", nullable=true)
     */
    private $userFather;
